...
def add_ubteacher_config2(cfg):
    ...
    _C.CONTRASTIVE = CN()
    _C.CONTRASTIVE.DENSE = False
    _C.CONTRASTIVE.AVGPOOL = None
    _C.CONTRASTIVE.ALLLAYERS = False
    _C.CONTRASTIVE.LAYER = 5
    _C.CONTRASTIVE.PREDICTOR = False
    _C.CONTRASTIVE.PROJECTOR = False
    _C.CONTRASTIVE.FPN = False
    _C.CONTRASTIVE.RPN = None
    _C.CONTRASTIVE.RPN_THRESHOLD = None
    _C.CONTRASTIVE.ROI_NMS = 0.5
    _C.CONTRASTIVE.ROI_THRESHOLD = 0.5